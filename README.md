...
npm run test:e2e
\`\`\`
*The test runner will autonomously register a QA user, retrieve the JWT Token, and execute operations across every module while verifying the SQL relational logic.*
